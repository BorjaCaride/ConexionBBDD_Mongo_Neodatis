...
public class Bajas {
    ...
    public static void bajaEmpresario(BufferedReader lee,MongoDatabase db) throws IOException {
...
//Metodo por si el administrador quiere dar de baja un empresario
    ...
    public static void bajaCandidato(BufferedReader lee,MongoDatabase db) throws IOException {//Metodo por si el admin quiere dar de baja un candidato
    ...
    public static void bajaFormacion(BufferedReader lee,MongoDatabase db) throws IOException {//M3etodo por si el admin quiere borrar una formacion
