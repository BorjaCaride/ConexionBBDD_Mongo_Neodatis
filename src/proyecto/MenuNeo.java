 ...
 * @author a16raulic
 */
public class MenuNeo {
    
    
    

    public static int menuPrincipal( BufferedReader lee) throws IOException {
    ...
    public static int menuLogin(BufferedReader lee) throws IOException {
        ...
        try {
            ...
            Object o = null;
            String usuario = Comprobar.compDniNeo(dni);

            if (usuario.equalsIgnoreCase("empresario")) {

                opcionMenuEmpresario(lee,dni);

            } else if (usuario.equalsIgnoreCase("candidato")) {

                opcionMenuCandidato(lee, dni);
            } else {
    ...
    public static void opcionMenuAdmin(BufferedReader lee) throws IOException {
        int opc = 999;
        int opc2 = 999;
        do {
            try {
            ...
            switch (opc) {
                case 1:
                    do {
                        ...
                        switch (opc2) {
                            ...
                            case 1:
                               Inserciones.altasFormacionesNeo(lee);
                ...
                case 4:
                    do{
                        ...
                        switch (opcV) {
                            case 1:
                                Visualizar.visualizarEmpresarioNeo();
                             ///   Visualizar.visualizarEmpresario(db);
                                break;
                            case 2:
                                Visualizar.visualizarCandidatoNeo();
    ...
    public static void opcionMenuEmpresario(BufferedReader lee,String dni) throws IOException {
        int opcE = 999;
        do {
            try {
            ...
            switch (opcE) {
                case 1:
                    Inserciones.altaAnuncioNeo(lee,dni);
                    break;
                ...
                case 4:
                  //  Visualizar.visualizarSolicitudes(lee,  dni);
    ...
    public static void opcionMenuCandidato(BufferedReader lee, String dni) throws IOException {
            ...
            switch (opcC) {
                case 1:
                    opcC = filtroAnuncio(lee);
                        switch(opcC){
                            case 1://Formacion
                             //   Visualizar.visualizarAnuncioFormacion(lee,  dni);
                                break;
                            case 2://Localidad
                              //  Visualizar.visualizarAnuncioLocalidad(lee, dni);
                                break;
                            case 3://Todos;
                              //  Visualizar.visualizarAnuncio(lee, dni);
                                break;
                            default:
                ...
                case 2:
                   // Modificaciones.modifCV(lee, dni);
                    break;
